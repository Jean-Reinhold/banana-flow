...
const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-neutral-800 rounded-lg shadow-xl w-full max-w-2xl flex flex-col"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2 w-48">
                    <input
                      ...
                      onChange={(e) =>
                        setLocalTheme((t) => ({ ...t, nodeOpacity: parseFloat(e.target.value) }))
                      }
                      className="w-full"
                    />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2 w-48">
                    ...
                    <input
                      ...
                      onChange={(e) => setLocalZoom(parseFloat(e.target.value))}
                      className="w-20 px-2 py-1 text-center text-white bg-neutral-900 border border-neutral-700 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2 w-48">
                    <input
                      ...
                      max="10"
                      step="1"
                      value={localTheme.edgeWidth}
                      onChange={(e) =>
                        setLocalTheme((t) => ({ ...t, edgeWidth: parseInt(e.target.value) }))
                      }
                      className="w-full"
                    />
                    <span className="text-sm text-gray-300 w-8 text-center">
                      {localTheme.edgeWidth}px
                    </span>
                  </div>
                </div>
                <ColorInput
                  ...
                  onChange={(val) =>
                    setLocalTheme((t) => ({ ...t, edgeColors: { ...t.edgeColors, text: val } }))
                  }
                />
                <ColorInput
                  ...
                  onChange={(val) =>
                    setLocalTheme((t) => ({ ...t, edgeColors: { ...t.edgeColors, image: val } }))
                  }
                />
                <ColorInput
                  ...
                  onChange={(val) =>
                    setLocalTheme((t) => ({ ...t, edgeColors: { ...t.edgeColors, video: val } }))
                  }
                />
                <ColorInput
                  ...
                  onChange={(val) =>
                    setLocalTheme((t) => ({ ...t, edgeColors: { ...t.edgeColors, any: val } }))
                  }
                />
              </div>
            </div>
