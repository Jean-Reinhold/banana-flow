...
const NodeComponent: React.FC<NodeProps> = ({ node, isSelected, onMouseDown, onHandleMouseDown, onResizeMouseDown, updateNodeData, onEditPrompt, onDeleteNode, edgeColors }) => {
  const { data } = node;
